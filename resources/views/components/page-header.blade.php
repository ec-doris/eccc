<div class="ecl-page-header-core ecl-page-header-core--image"
     style="background-image:url(https://inno-ecl.s3.amazonaws.com/media/examples/example-image8.jpg)">
        ...
        <nav class="ecl-page-header-core__breadcrumb ecl-breadcrumb-core" aria-label="You are here:"
            ...
            <ol class="ecl-breadcrumb-core__container">
                <li class="ecl-breadcrumb-core__segment" data-ecl-breadcrumb-core-item="static" aria-hidden="false"><a
                        href="/" class="ecl-breadcrumb-core__link ecl-link ecl-link--standalone">Home</a><svg
...
{{--                                                                     aria-label="Click to expand" data-ecl-breadcrumb-core-ellipsis-button="true">…</button><svg--}}
{{--                        focusable="false" aria-hidden="true" role="presentation"--}}
{{--                        class="ecl-breadcrumb-core__icon ecl-icon ecl-icon--2xs ecl-icon--rotate-90">--}}
{{--                        <use xlink:href="/component-library/dist/media/icons.3cf410f9.svg#ui--corner-arrow"></use>--}}
{{--                    </svg></li>--}}
